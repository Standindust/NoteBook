...
public class MainActivity extends Activity implements OnScrollListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weihuzhe =findViewById(R.id.btn_weihuzhe);
        mContext = this;

        weihuzhe.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View arg0) {
                NoteEdit.ENTER_STATE = 0;
                Intent intent = new Intent(MainActivity.this, weihuzhe.class);
...
//
    simp_adapter = new SimpleAdapter(this, getData(), R.layout.item,
                new String[] { "tv_title", "tv_content","tv_date","tv_writer" }, new int[] {
                R.id.tv_title,R.id.tv_content, R.id.tv_date ,R.id.tv_writer});
        listview.setAdapter(simp_adapter);
    }
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        while (c.moveToNext()) {
            ...
            bundle.putString("infot", title);
            bundle.putString("infow", writer);
