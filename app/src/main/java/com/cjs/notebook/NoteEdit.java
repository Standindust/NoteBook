...
public class NoteEdit extends Activity {
	...
	public static String last_writer;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		last_title = myBundle.getString("infot");
		last_writer= myBundle.getString("infow");


	Log.d("LAST_CONTENT", last_content);
		et_content.setText(last_content);
		et_writer.setText(last_writer);
		...
		btn_ok.setOnClickListener(new OnClickListener() {
			public void onClick(View arg0) {
				...
				// 保存和修改一个已有日志
						...
						String updatesql = "update note set title="+"'"+title+"',content="+"'"+content+
								"',writer="+"'"+writer+"',date="+"'"+dateNum+"'"+"where _id=" + id;
